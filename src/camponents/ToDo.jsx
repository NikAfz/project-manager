...
import dh from "../assets/drag_handle.png";
...
function ToDo(props) {
  ...
  return (
    <>
      ...
      >
        <img src={dh} alt="drag here" width={35} />
      </div>
      <div
        className="todo--list"
        onPointerOut={() => handleSetNotDragging("outSide")}
      >
        <div className="todo--list-header">
          <h2 className="todo--list-name" title={props.name}>
            {props.name}
          </h2>
          <div
            className="remove"
        ...
        <div className="todo--list-content">{renderToDo}</div>
        <div className="add-todo--container">
          {addToDoOpener ? (
            <form className="add-todo--form" onSubmit={handleSubmit}>
              ...
              />
              <button className="add-todo--btn" title="add" type="submit">
                &#10004;
              </button>
            </form>
          ) : (
